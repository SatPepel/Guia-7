...
public class Ejercicio3Guia7 {
    ...
    operacion1.crearOperacion();
        System.out.println("La suma de los dos valres es: " + operacion1.sumar());
        System.out.println("La resta de los dos valores es; " + operacion1.restar());
        System.out.println("La multiplicacion de ambos valores es " + operacion1.multiplicar());
        System.out.println("La division de ambos valores es " + operacion1.dividir());
    }
